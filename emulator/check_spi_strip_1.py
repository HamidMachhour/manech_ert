...
def send_to_strip(spi, led_list):
    ...
    # --- THE BYPASS HACK ---
    # Inject an absolute black [0, 0, 0] pixel at the very beginning of the data stream.
    # This absorbs the broken 1st physical LED and pushes your true data to LEDs 2-17.
    effective_list = [[0, 0, 0]] + led_list
...
def main():
    print("==================================================")
    print("   WS2812B LED Tester (Skipping Broken Pixel 1)   ")
    print("==================================================")
    ...
    LED_COUNT = 16 # Your 16 structural testing lights
